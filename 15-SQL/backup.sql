...
--
-- Table structure for table `gynms`
--

DROP TABLE IF EXISTS `gynms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gynms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `gynms`
--

LOCK TABLES `gynms` WRITE;
/*!40000 ALTER TABLE `gynms` DISABLE KEYS */;
/*!40000 ALTER TABLE `gynms` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-11-06 20:52:07
