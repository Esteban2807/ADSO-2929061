...
<h1 class="bg-black/80 mt-6 text-4xl text-white flex gap-2 items-center justify-center p-6 pb-4 border-b-2 border-neutral-50 mb-10">
...
<div class="flex flex-col gap-4 justify-center items-center">
    <div class="join mx-auto">
        <a class="btn btn-outline btn-success join-item" href="{{ url('adoptions/create') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
                <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm48-88a8,8,0,0,1-8,8H136v32a8,8,0,0,1-16,0V136H88a8,8,0,0,1,0-16h32V88a8,8,0,0,1,16,0v32h32A8,8,0,0,1,176,128Z"></path>
            </svg>
            <span class="hidden md:inline">Add Adoption</span>
        </a>
        <a class="btn btn-outline text-white hover:bg-[#fff6] hover:text-white join-item" href="{{ url('export/adoptions/pdf') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
                <path d="M224,152a8,8,0,0,1-8,8H192v16h16a8,8,0,0,1,0,16H192v16a8,8,0,0,1-16,0V152a8,8,0,0,1,8-8h32A8,8,0,0,1,224,152ZM92,172a28,28,0,0,1-28,28H56v8a8,8,0,0,1-16,0V152a8,8,0,0,1,8-8H64A28,28,0,0,1,92,172Zm-16,0a12,12,0,0,0-12-12H56v24h8A12,12,0,0,0,76,172Zm88,8a36,36,0,0,1-36,36H112a8,8,0,0,1-16,0V152a8,8,0,0,1,8-8h16A36,36,0,0,1,164,180Zm-16,0a20,20,0,0,0-20-20h-8v40h8A20,20,0,0,0,148,180ZM40,112V40A16,16,0,0,1,56,24h96a8,8,0,0,1,5.66,2.34l56,56A8,8,0,0,1,216,88v24a8,8,0,0,1-16,0V96H152a8,8,0,0,1-8-8V40H56v72a8,8,0,0,1-16,0ZM160,80h28.69L160,51.31Z"></path>
            </svg>
...
<table class="table bg-black/80 text-white">
    ...
    <tbody class="datalist">
        ...
        <tr>
            ...
            <td>
                <a href="{{ url('adoptions/' . $adoption->id ) }}" class="btn btn-outline btnxs btn-default">
                ...
                <a href="{{ url('adoptions/' . $adoption->id . '/edit') }}" class="btn btn-outline btnxs btn-default">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#ededed" viewBox="0 0 256 256">
                        <path d="M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM51.31,160,136,75.31,152.69,92,68,176.68ZM48,179.31,76.69,208H48Zm48,25.38L79.31,188,164,103.31,180.69,120Zm96-96L147.31,64l24-24L216,84.68Z"></path>
                    </svg>
                </a>
                <a href="javascript:;" class="btn btn-outline btnxs btn-error btn-delete" data-name="{{ $adoption->id }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#ededed" viewBox="0 0 256 256">
                        <path d="M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM96,40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8v8H96Zm96,168H64V64H192ZM112,104v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm48,0v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Z"></path>
                    </svg>
                </a>
                <form  class="hidden" method="POST" action="{{ url('adoptions/' . $adoption->id) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </td>
        ...
        @endforeach
        <tr>
            <td colspan="5" class="text-center">{{ $adoptions->links() }}</td>
        </tr>
    </tbody>
</table>
@endsection
...
@section('js')
    ...
    <script>
        $('.btn-delete').click(function(){
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this! The adoption #" + id + " will be deleted.",
                icon: "warning",
        ...
        $('body').on('input', '#qsearch', function(event) {
            ...
            $('.datalist').html(`<tr>
                                    <td colspan="5" class="text-center py-18">
