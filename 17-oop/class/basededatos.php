...
{
	private $BaseDatos = 'pokeadso';		// nombre de la base de datos
	private $Servidor = '127.0.0.1';		// nombre del servidor
	...
	public function ejecutarSQL($sql)
	{
		if ($this->Conexion_ID) {
			try {
				...
				return $this->Consulta_ID; // <-- Agrega este return
			} catch (PDOException $e) {
				$this->ErrTxt = $e->getMessage();
				return false;
			}
	...
	*/
	protected function cargarTodo()
	{
		...
		// $this->desconectar(); // No desconectar aquí
